...
module.exports = function(gulp, config) {
  ...
  gulp.task('ng:beforePages', noop);
  gulp.task('ng:afterPages', noop);
  ...
  if(config.type === 'application') {
    ...
    gulp.task('ng:pages', function() {
      runSequence('ng:beforePages', 'ng:pages/clean', ['ng:pages/views'/*, 'ng:pages/copy'*/], 'ng:afterPages');
    });
