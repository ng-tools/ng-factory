...
module.exports = function(gulp, config) {
  ...
  gulp.task('ng:docs/views', function() {
    ...
    return require('./locals')(config).then(function(locals) {
      ...
      var index = gulp.src(docs.index, {cwd: docs.cwd, base: docs.cwd})
        ...
        .pipe(combine(
          ...
          inject(
             merge(gulp.src(src.scripts, {cwd: src.cwd, read: false}), gulp.src('examples/**/*.js', {cwd: docs.cwd, read: false})),
            {name: 'src', addRootSlash: false}
          ),
          inject(
